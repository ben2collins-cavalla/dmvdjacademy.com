    ...
    if(! mobileBrowserDetection()){
        $(".navbar-nav li").hover(function() {
          ...
          if (isHovered) {
            ...
            $(this).children('.caret').stop().slideDown(300);
          }
          else {
            $(this).children("ul").stop().slideUp(300);
            $(this).children('.caret').stop().slideUp(300);
          }
        });
    }
    drop_down_mobile_menu_();
...
function mobileBrowserDetection() {
  ...
  function drop_down_mobile_menu_(){


    var $=  jQuery;
    $( ".menu-wrap .nav-item button" ).each(function(i) {
      $( this ).addClass( "mobile_dropdown_btn_"+i);
    });


    $( ".menu-wrap .nav-item .dropdown" ).each(function(i) {
      $( this ).addClass( "mobile_dropdown_"+i);
    });

     $( ".menu-wrap .nav-item button" ).each(function(i) {
      $( ".mobile_dropdown_btn_"+i ).click(function(){
        $( ".mobile_dropdown_"+i).toggle();
          $(this).closest( '.menu-wrap .nav-item' ).toggleClass('active_dropdown_menu');
      });
    });
  }