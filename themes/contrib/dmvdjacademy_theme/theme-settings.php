...
/**
 * @file
 * dmvdjacademy, add custom theme settings options here.
 */
...
function dmvdjacademy_theme_form_system_theme_settings_alter(&$form, Drupal\Core\Form\FormStateInterface $form_state) {

/*   $form['dmvdjacademy_menu_settings'] = array(
    '#type' => 'details',
    '#title' => t('Navigation Menu Display Settings'),
  );

  $form['dmvdjacademy_menu_settings']['menu_display'] = array(
    '#type' => 'fieldset',
  ...
  $form['dmvdjacademy_menu_settings']['menu_display']['menu_display_variations'] = array(
    '#type' => 'select',
    '#options' => [
  ...
  // Footer
  $form['dmvdjacademy_footer_settings'] = array(
    '#type' => 'details',
    '#title' => t('Footer Settings'),
  );
  // Social media
  $form['dmvdjacademy_footer_settings']['social_links'] = array(
    '#type' => 'details',
  ...
  // Address/contact
  $form['dmvdjacademy_footer_settings']['address'] = array(
    '#type' => 'details',
    '#title' => t('Address'),
    '#weight' => 100,
    '#collapsible' => true,
  ...
  $form['dmvdjacademy_footer_settings']['address']['address_organization_name'] = array(
    '#type' => 'textfield',
    '#title' => t('Organization Name'),
    '#default_value' => theme_get_setting('address_organization_name'),
    '#description' => t("Add your organization's name."),
  );
  $form['dmvdjacademy_footer_settings']['address']['address_street'] = array(
    '#type' => 'textfield',
    '#title' => t('Street'),
    '#default_value' => theme_get_setting('address_street'),
    '#description' => t('Add your address.'),
  );
  $form['dmvdjacademy_footer_settings']['address']['address_city_state_zipcode'] = array(
    '#type' => 'textfield',
  ...
  $form['dmvdjacademy_footer_settings']['address']['address_phone'] = array(
    '#type' => 'textfield',
    '#title' => t('Phone'),
    '#default_value' => theme_get_setting('address_phone'),
    '#description' => t('Add a phone number.'),
  );
  $form['dmvdjacademy_footer_settings']['address']['address_email'] = array(
    '#type' => 'textfield',
    '#title' => t('E-mail'),
